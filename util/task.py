...
##add the new nose4 mask
def nose_mask(img, nose_x, nose_y, path):
    ...
    new_img = trans(mask).resize((266, 266))
    new_img = new_img.crop((7, 6, 263, 262))
    mask = trans1(new_img.resize((256, 256)))
